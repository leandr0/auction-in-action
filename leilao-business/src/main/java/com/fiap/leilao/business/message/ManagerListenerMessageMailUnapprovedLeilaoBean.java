...
@MessageDriven(
		activationConfig ={
				...
				@ActivationConfigProperty(
						...
						propertyValue = ResourceAdapterMessage.JNDI_QUEUE_REPROVACAO_MAIL
				)		
		}
)
/*
...
public class ManagerListenerMessageMailUnapprovedLeilaoBean implements MessageListener {
	
	
	private static final Log LOG = LogFactory.getLog(ManagerListenerMessageMailUnapprovedLeilaoBean.class);
